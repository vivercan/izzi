import { Truck, UserPlus, BarChart3, Route, Wrench, Activity, Settings, FileText, TrendingUp, Package, LogOut, Sparkles, Headphones, Lock } from 'lucide-react';
...
export const DashboardScreen = ({ onLogout, onNavigate, userRole = 'admin', userName = 'Usuario' }: DashboardScreenProps) => {
  ...
  const modules = [
    ...
    { id: 'sales-horizon', name: 'Sales Horizon', icon: TrendingUp },
  ];
