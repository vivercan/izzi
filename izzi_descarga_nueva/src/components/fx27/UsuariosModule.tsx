  ...
  return (
    <div className="min-h-screen" style={{ background: 'linear-gradient(135deg, #0056B8 0%, #0B84FF 100%)' }}>
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        <button
          onClick={onBack}
          className="absolute top-6 right-8 z-20 flex items-center gap-2 px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 text-white/70 hover:text-orange-400 transition-all duration-200 backdrop-blur-sm border border-white/20 cursor-pointer group"
          style={{
            fontFamily: "'Exo 2', sans-serif",
            fontSize: '14px',
            fontWeight: 600
